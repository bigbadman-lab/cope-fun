        ...
        >
          <div className="relative min-h-[24px] flex-1">
            {showTypewriter && typewriterText && (
              <span
                aria-hidden
                className="pointer-events-none absolute inset-0 text-base leading-relaxed text-zinc-500 dark:text-zinc-500"
              >
                {typewriterText}
              </span>
            )}
            <textarea
              ...
              className={`relative max-h-32 min-h-[24px] w-full resize-none bg-transparent text-base leading-relaxed text-zinc-900 placeholder:text-zinc-500 focus:outline-none dark:text-zinc-100 dark:placeholder:text-zinc-600 ${
